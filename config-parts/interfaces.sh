...
set interfaces ethernet eth1 vif 10 address '10.8.11.1/24'
...
set interfaces wireguard wg01 address '10.8.12.1/24'
set interfaces wireguard wg01 description 'WIREGUARD'
set interfaces wireguard wg01 peer nat-mobile allowed-ips '10.8.12.4/32'
