...
set firewall zone guest from kids firewall name 'kids-guest'
...
set firewall zone iot from kids firewall name 'kids-iot'
...
set firewall zone lan from kids firewall name 'kids-lan'
...
set firewall zone local from kids firewall name 'kids-local'
...
set firewall zone servers from kids firewall name 'kids-servers'
...
set firewall zone services from kids firewall name 'kids-services'
...
set firewall zone trusted from kids firewall name 'kids-trusted'
...
set firewall zone video from kids firewall name 'kids-video'
set firewall zone video interface 'eth1.50'
set firewall zone wan default-action 'drop'

# KIDS
set firewall zone kids default-action 'drop'
set firewall zone kids from guest firewall name 'guest-kids'
set firewall zone kids from iot firewall name 'iot-kids'
set firewall zone kids from local firewall name 'local-kids'
set firewall zone kids from servers firewall name 'servers-kids'
set firewall zone kids from services firewall name 'services-kids'
...
set firewall zone kids from video firewall name 'kids-wan'
