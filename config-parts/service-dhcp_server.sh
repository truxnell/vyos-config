...
set service dhcp-server shared-network-name IOT subnet 10.8.30.0/24 static-mapping tv-middlelounge mac-address 'bc:8c:cd:77:e0:99'
set service dhcp-server shared-network-name IOT subnet 10.8.30.0/24 static-mapping tv-bedroom ip-address '10.8.30.12'
