...
# cloudflare-ddns
#
# NO LONGER REQUIRED, I CAN HAZ STATIC IP NOW
#
# set container name cloudflare-ddns allow-host-networks
# set container name cloudflare-ddns environment CF_API_TOKEN value "${SECRET_CLOUDFLARE_DYNDNS_TOKEN}"
# set container name cloudflare-ddns environment DOMAINS value 'ipv4.trux.dev,games.trux.dev,irc.voltaicforge.com'
...
set container name coredns network containers address '10.5.0.3'
...
set container name bind network containers address '10.5.0.13'
...
set container name gatus network containers address '10.5.0.12'
