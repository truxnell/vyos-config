...
set system static-host-mapping host-name irc.voltaicforge.com inet 10.8.20.223
set system static-host-mapping host-name shynet.voltaicforge.com inet 10.8.20.223
