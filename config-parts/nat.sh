...
# set nat destination rule 111 description 'Factorio - Squareworld'
# set nat destination rule 111 destination port '34204'
# set nat destination rule 111 inbound-interface 'eth0'
# set nat destination rule 111 protocol 'tcp_udp'
# set nat destination rule 111 translation address '10.8.20.230'
# set nat destination rule 111 translation port '34204'
...
set nat destination rule 112 description 'Force DNS for Kids'
set nat destination rule 112 destination address '!10.5.0.4'
set nat destination rule 112 destination port '53'
set nat destination rule 112 inbound-interface 'eth1.40'
set nat destination rule 112 protocol 'tcp_udp'
set nat destination rule 112 translation address '10.5.0.4'
set nat destination rule 112 translation port '53'
